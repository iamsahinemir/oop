...
public class ManagerMenu {
    ...
    private void updateEmployeeNonProfile(Scanner scanner) {
        ...
        if (scanner.hasNextInt()) {
            ...
            System.out.print("Enter new name (or leave blank to skip): ");
            String name = scanner.nextLine();
            System.out.print("Enter new surname (or leave blank to skip): ");
            String surname = scanner.nextLine();
            System.out.print("Enter new role (or leave blank to skip): ");
            String role = scanner.nextLine();
    ...
    private void runSortingAlgorithms(Scanner scanner) {
        ...
        if (scanner.hasNextInt()) {
            ...
            Algorithms.radixSort(radixData);
            ...
            startTime = System.nanoTime();
            Algorithms.shellSort(shellData);
            endTime = System.nanoTime();
            ...
            startTime = System.nanoTime();
            Algorithms.insertionSort(insertionData);
            endTime = System.nanoTime();
